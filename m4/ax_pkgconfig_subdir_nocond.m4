...
# SYNOPSIS
#
#   AX_PKGCONFIG_SUBDIR_NOCOND(path/to/subproject)
#
# DESCRIPTION
#
...
#
#     - Cancelled: Enable automake conditional SUBPROJECT_INTERNAL
#
# LICENSE
#
# Written in 2015 by David Mazieres.  Placed in public domain.
#
AC_DEFUN([AX_PKGCONFIG_SUBDIR_NOCOND],
[dir="$1"
...
dnl AM_CONDITIONAL(translit(pcname, a-z, A-Z)_INTERNAL,
dnl               [test -n "$pcname[]_INTERNAL"])
popdef([pcname])dnl
